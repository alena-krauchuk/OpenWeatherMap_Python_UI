...
class FooterElementsText:
    ...
    ASK_A_QUESTION_LINK_TEXT = "Ask a question"
    BLOG_LINK_TEXT = "Blog"
    ...
    footer_elements_text = {
        ...
        "ASK_A_QUESTION_LINK_TEXT": "Ask a question",
        "BLOG_LINK_TEXT": "Blog",
        "COMPANY_SECTION_CONTENT_TEXT":
            "OpenWeather is a team of IT experts and data scientists that has been practising deep weather data "
            "science. For each point on the globe, OpenWeather provides historical, current and forecasted weather data"
