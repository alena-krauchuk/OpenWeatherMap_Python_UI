...
class TestFooterLinksClickability:
    ...
    def test_tc_01_05_25_check_clickability_of_medium_link(self, driver):
        """Checks if the Medium link is clickable on the Main Page"""
        page = FooterPage(driver, URL_MAIN_PAGE)
        page.open()
        assert page.element_is_clickable(self.footer_locators.MEDIUM_LINK), \
            "The Medium link is not clickable on the Main Page"

    def test_tc_01_05_26_check_clickability_of_telegram_link(self, driver):
        """Checks if the Telegram link is clickable on the Main Page"""
        page = FooterPage(driver, URL_MAIN_PAGE)
        page.open()
...
class TestFooterLinksInteractivity:
    ...
    def test_tc_01_06_14_check_interactivity_of_privacy_policy_link(self, driver):
        """Checks if the Privacy Policy link is interactive on the Main Page"""
        page = FooterPage(driver, URL_MAIN_PAGE)
        page.open()
        assert "pointer" in page.hover_over_element(self.footer_locators.PRIVACY_POLICY_LINK, 'cursor', 2), \
            "The cursor does not change to a 'hand' when hovering over the Privacy Policy link"

    def test_tc_01_06_15_check_interactivity_of_website_terms_and_conditions_link(self, driver):
    ...
    def test_tc_01_06_16_check_interactivity_of_about_us_link(self, driver):
        """Checks if the About us link is interactive on the Main Page"""
        page = FooterPage(driver, URL_MAIN_PAGE)
        page.open()
        assert "pointer" in page.hover_over_element(self.footer_locators.ABOUT_US_LINK, 'cursor', 2), \
            "The cursor does not change to a 'hand' when hovering over the About us link"

    def test_tc_01_06_17_check_interactivity_of_blog_link(self, driver):
        """Checks if the Blog link is interactive on the Main Page"""
        page = FooterPage(driver, URL_MAIN_PAGE)
        page.open()
        assert "pointer" in page.hover_over_element(self.footer_locators.BLOG_LINK, 'cursor', 2), \
            "The cursor does not change to a 'hand' when hovering over the Blog link"

    def test_tc_01_06_18_check_interactivity_of_openweather_for_business_link(self, driver):
        """Checks if the OpenWeather for Business link is interactive on the Main Page"""
        page = FooterPage(driver, URL_MAIN_PAGE)
        page.open()
    ...
    def test_tc_01_06_21_check_interactivity_of_get_it_on_google_play_link(self, driver):
        """Checks if the GET IT ON Google Play link is interactive on the Main Page"""
        page = FooterPage(driver, URL_MAIN_PAGE)
        page.open()
    ...
    def test_tc_01_06_23_check_interactivity_of_twitter_link(self, driver):
        """Checks if the Twitter link is interactive on the Main Page"""
        page = FooterPage(driver, URL_MAIN_PAGE)
        page.open()
        assert "pointer" in page.hover_over_element(self.footer_locators.TWITTER_LINK, 'cursor', 2), \
            "The cursor does not change to a 'hand' when hovering over the Twitter link"

    def test_tc_01_06_24_check_interactivity_of_linkedin_link(self, driver):
        """Checks if the LinkedIn link is interactive on the Main Page"""
        page = FooterPage(driver, URL_MAIN_PAGE)
        page.open()
    ...
    def test_tc_01_06_26_check_interactivity_of_telegram_link(self, driver):
        """Checks if the Telegram link is interactive on the Main Page"""
        page = FooterPage(driver, URL_MAIN_PAGE)
        page.open()
        assert "pointer" in page.hover_over_element(self.footer_locators.TELEGRAM_LINK, 'cursor', 2), \
            "The cursor does not change to a 'hand' when hovering over the Telegram link"

    def test_tc_01_06_27_check_interactivity_of_github_link(self, driver):
        """Checks if the GitHub link is interactive on the Main Page"""
        page = FooterPage(driver, URL_MAIN_PAGE)
        page.open()
        assert "pointer" in page.hover_over_element(self.footer_locators.GITHUB_LINK, 'cursor', 2), \
